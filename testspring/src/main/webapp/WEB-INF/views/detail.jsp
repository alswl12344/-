...
<script>
   ...
   $(document).ready(function(){
      ...
      //댓글 저장 버튼 클릭 이벤트(댓글쓰기)
//      $(btuReplySave).on('click', function); 두가지방법
      $(document).on('click','#btuReplySave', function(){
   ...
   $(function(){
	...
	<div>
		...
		<table>
		<tr>
			<td rowspan="2" width="70%"><textarea class="form-contorl"name="rememo" id="rememo" placeholder="댓글을 입력하세요"></textarea></td>
			<td><input type="text" name="rewriter" id="rewriter" placeholder="댓글작성자"></td>		
		</tr>
		<tr>
			<td><button type="button" id="btuReplySave">저장</button></td>
		</tr>
		</table>
		</div>
	</div>
